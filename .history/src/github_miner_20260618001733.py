...
if __name__ == "__main__":
    ...
    for city in ["Nuremberg", "Berlin"]:
        raw_items, validated_users = miner.fetch_developers_by_location(location=city, max_pages=1)
        print(f"Successfully fetched {len(validated_users)} profiles inside {city}.\n")
        saving_data(city, raw_data, )