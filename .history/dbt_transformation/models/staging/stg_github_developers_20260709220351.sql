        ...
        case 
            when company is null or trim(company) = '' then null
                ...
                case trim(ltrim(trim(company), '@'))
                    ...
                    -- Antruvia
                    when 'Antruvia' then 'Atruvia AG'

                    -- Microsoft
                    when 'microsoft' then 'Microsoft'

                    -- Aleph Alpha
                    when 'Aleph-Alpha' then 'Aleph Alpha'

                    -- Delivery Hero
                    when 'deliveryhero' then 'Delivery Hero'

                    -- Babbel
                    when 'babbel' then 'Babbel'
                    ...
                    when 'German Cancer Research Center' then 'DKFZ'
                    when 'MIC-DKFZ' then 'DKFZ'
                    ...
                    when 'KIT @kit-sdq' then 'KIT'
                    when 'Student at KIT' then 'KIT'
                    when 'Karlsruhe Institute for Technology' then 'KIT'
                    ...
                    -- Siemens
                    when 'Siemens AG' then 'Siemens'

                    -- BMW
                    when 'bmw' then 'BMW'
                    when 'BMW Group' then 'BMW'
                    ...
                    when 'Centre for Astronomy, Heidelberg University' then 'University of Heidelberg'
                    when 'MPIA' then 'University of Heidelberg'
                    when 'Heidelberg University, Germany' then 'University of Heidelberg'
                    when 'Max-Planck-Institut für Astronomie' then 'University of Heidelberg'
                    when 'mpi-astronomy' then 'University of Heidelberg'
                    when 'Ruprecht-Karls-Universität Heidelberg' then 'University of Heidelberg'
                    when 'Uni Heidelberg' then 'University of Heidelberg'
